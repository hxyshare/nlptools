...
USER_DIR = Path.expanduser(Path('~')).joinpath('.corrector')
...
language_model_path = os.path.join(USER_DATA_DIR, 'xiaoai_query_correct_20200303.bin')
...
custom_word_freq_path = os.path.join(pwd_path, 'data/new_domain_session_pairs_ner.txt')
# 知名人名词典 format: 词语 词频
